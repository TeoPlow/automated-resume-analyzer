...
class MatchingConfig:
    ...
    DEFAULT_WEIGHT_SKILLS: float = float(
        os.getenv("DEFAULT_WEIGHT_SKILLS", "0.40")
    )
    DEFAULT_WEIGHT_EXPERIENCE: float = float(
        os.getenv("DEFAULT_WEIGHT_EXPERIENCE", "0.25")
    )
    DEFAULT_WEIGHT_GRADE: float = float(
        os.getenv("DEFAULT_WEIGHT_GRADE", "0.15")
    )
    DEFAULT_WEIGHT_LOCATION: float = float(
        os.getenv("DEFAULT_WEIGHT_LOCATION", "0.10")
    )
    DEFAULT_WEIGHT_SALARY: float = float(
        os.getenv("DEFAULT_WEIGHT_SALARY", "0.10")
    )
