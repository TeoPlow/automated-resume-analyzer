...
class ServiceClient:
    ...
    async def get_vacancy(self, vacancy_id: str) -> dict:
        """Получить вакансию через внутренний API сервиса Вакансий"""
    ...
    async def get_candidates_bulk(self, candidate_ids: list[str]) -> list[dict]:
        """Получить кандидатов через внутренний API сервиса Профилей"""
    ...
    async def get_vacancies_bulk(self, vacancy_ids: list[str]) -> list[dict]:
        """Получить вакансии через внутренний API сервиса Вакансий"""
    ...
    async def get_candidate(self, candidate_id: str) -> dict:
        """Получить одного кандидата через внутренний API сервиса Профилей"""
