...
class MatchingEventPublisher:
    def __init__(self) -> None:
        ...
        self._producer_name = os.getenv("MATCHING_EVENT_PRODUCER", "matching-service")
        self._required = os.getenv("MATCHING_EVENTS_REQUIRED", "false").lower() in {"1", "true", "yes", "on"}
        ...
        try:
            ...
            if self._required:
                raise make_http_exception(
                    ...
                    message="Failed to publish matching event",
...
publisher: MatchingEventPublisher | None = None


def get_event_publisher() -> MatchingEventPublisher:
    global publisher
