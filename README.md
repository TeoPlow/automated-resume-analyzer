...
Разработка системы автоматизированной обработки потока резюме для вакансий
...
# Что сделать?
1. ~~Подключить проверялку покрытия тестами~~
2. ~~Проанализировать сервис Gateway, написать много тестов~~
3. ~~Проанализировать сервис Matching, написать много тестов~~
4. ~~Проанализировать сервис Profile, написать много тестов~~
5. Проанализировать сервис Search, написать много тестов
6. Проанализировать сервис Vacancy, написать много тестов
7. Накинуть faker для тестов
8. При дедупликации, проверяется ли, с одной ли "почты" (один ли тот же человек) отправил резюме. Вдруг его отправили разные люди чтобы поднасрать
9. Провести нагрузочное тестирование. Описать это в тексте диплома
